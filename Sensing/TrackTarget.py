...
if __name__ == '__main__':
    ...
    if len(trackTarget.centers) != 0:
        trackTarget.camShiftTracking(trackTarget.centers[0][0], trackTarget.centers[0][1],
                                 trackTarget.centers[0][2], trackTarget.centers[0][3])
